      ...
      <main className="py-12 md:py-20 bg-[var(--background)]">
        <div className="container-shell">
          ...
          <section className="pt-20 border-t border-[var(--border)] mb-24">
            ...
            <Card className="p-8 md:p-12 border-2 border-[var(--accent-soft)] relative overflow-hidden bg-gradient-to-br from-[#FAF8F6] to-[#F3EFED] shadow-2xl max-w-5xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
                <div className="max-w-xl text-center md:text-left">
                  <h3 className="text-3xl font-bold tracking-tight mb-6">Le document de toute une vie.</h3>
